...
def get_eff(llp_accept,csc_accept,csc_accept_loose,csc_accept_tight):
	...
	return [n_acc,csc_eff_loose,csc_eff,csc_eff_tight]
...
effs = get_eff(llp_accept,csc_accept,csc_accept_loose,csc_accept_tight)
#effs = get_eff(llp_accept,csc_accept,csc_accept_loose,csc_accept_tight,csc_ring)

# Free up Memory
llp_accept, csc_accept_loose, csc_accept_tight = None, None, None
#llp_accept, csc_accept_loose, csc_accept_tight, csc_ring = None, None, None, None

if not find_rate: print("%s,%s,%s,%i,%.2f%%,%.2f%%,%.2f%%"%(HM,LLPM,CTau,effs[0],effs[1]*100,effs[2]*100,effs[3]*100))
else: print("%s,%s,%s,%i,%.2f kHz,%.2f kHZ,%.2f kHz"%(HM,LLPM,CTau,effs[0],effs[1]*30000,effs[2]*30000,effs[3]*30000))
