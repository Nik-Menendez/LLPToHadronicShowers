...
cmsRunRAW = directory + "L1Trigger/CSCTriggerPrimitives/test/CSCTPEmulator_RAW2DIGI_Run3_MC_cfg.py"
cmsRunDIGI = directory + "L1Trigger/CSCTriggerPrimitives/test/CSCTPEmulator_Run3_MC_cfg.py"
cmsRun2RAW = directory + 'L1Trigger/CSCTriggerPrimitives/test/CSCTPEmulator_Run2018_data_cfg.py'
...
central_signal_redo_20210301 = [
    HTo2LongLivedTo4b_MH_350_MFF_80_CTau_10000mm
]

private_signal_redo_20210301 = [
    HTo2LongLivedTo4q_MH_125_MFF_1_CTau_5000mm
]
