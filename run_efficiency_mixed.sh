...
echo -e "Higgs Mass,LLP Mass,cTau,N in Acc,Loose,Loose R1,Loose R1+ALCT,Nom,Nom R1,Nom R1+ALCT,Tight,Tight R1,Tight R1+ALCT" > Efficiency_output.txt
search_dir=/eos/uscms/store/user/nimenend/Eff_Rate/Final
#search_dir=/eos/uscms/store/user/nimenend/Eff_Rate/Final/MH_125_MFF_50_CTau_30000mm.root
for entry in "$search_dir"/*
do
	echo $entry
	python3 efficiency_rate_mixed.py $entry eff >> Efficiency_output.txt
done
