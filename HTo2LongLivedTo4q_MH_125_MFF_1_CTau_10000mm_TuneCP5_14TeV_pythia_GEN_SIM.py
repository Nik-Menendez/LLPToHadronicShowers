...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('LLPToHadronicShowers/Generator/python/HTo2LongLivedTo4q_MH_125_MFF_1_CTau_10000mm_TuneCP5_14TeV_pythia8.py nevts:10'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            'POWHEG:nFinal = 3', 
            '9000006:all = sk   skbar    0        0          0       1  1.9732e-17  1.0  75.0 10000', 
